...
//	   pageObjectManager.getCartPage().verifyCompleteMealProductAdded_Into_SelectedItems(completeCealProduct);
	...
	public void verify_price_details_in_cart_page(String totalProduct, String product) {
		...
		String totalExpectedProductPrice = (String.valueOf(decimalFormat.format(totalProductsprice)));
	...
	public void fill_all_following_details() {
		...
		pageObjectManager.getCartPage().enterMobileNumberTextField("9730834941");
		pageObjectManager.getCartPage().enterEmailBoxTextField("shivanand.jangam@gmail.com");
