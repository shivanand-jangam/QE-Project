...
public class MenuPageStepDefination extends BaseTest {
	...
	public void make_a_note_of_pizz_amount_for(String product, String type) {
		...
		productPrice = String.valueOf(
				decimalFormat.format(Double.parseDouble(pageObjectManager
						.getMenuPage().getPriceOfGivenProduct(product, type))));
	}
	...
	public void verify_Price_in_the_checkout_section(String product) {
		pageObjectManager.getMenuPage().verifyPriceOfProductAddedInCart(product,
				productPrice);
	}
