Feature: verify end to end flow domino's
  I want to use this template for my feature file

  @tag1
  Scenario: verify user is able to perchase one veg pizza without login
    ...
    And user choose a specific vegetarian pizza "Peppy Paneer"
